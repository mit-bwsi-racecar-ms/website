...
What is RMS?
------------------------------
`Racecar Middle School <https://mit-bwsi-racecar-ms.github.io/website/docs/intro/welcome.html>`_, or RMS, is a STEM program designed for middle school students (grades 6 - 8) to learn programming and robotics through interactive, project-based labs. RMS teaches students how to develop code that enables a robotic car to navigate a race course. This course was developed through the `Beaver Works Summer Institute <https://beaverworks.ll.mit.edu/CMS/bw/bwsi>`_ (BWSI). 



Class Types
------------------------------
Online Course (online, self-taught)
	- This online, self-guided curriculum for middle school students uses a project-based approach to teach students STEM, programming, and team-building skills while they build a low-cost, driverless model car. The online curriculum was developed with the goal of enabling any interested middle school student to learn how to build and program their very own self-driving racecars by themselves. The online curriculum is built on top of the BWSI Summer Course. 

Crash Course (8 weeks, once-a-week)
...
RMS was developed in Summer 2019 as a BWSI pilot middle school program, with the goal to develop a curriculum that can reach and inspire underserved students in STEM. We have since ran a number of different iterations of RMS since then. The brochures and schedule of topics for each iteration taught can be found below:
	...
	- Fall 2019 (8 weeks, once-a-week) - `F19 Brochure <https://drive.google.com/open?id=1H0VLyKs8-WbNlk4RjzknRtsyomJ-q-EW>`_, `F19 Schedule <https://drive.google.com/open?id=1ac_2xJJAhlCd8aHTIsosuboxl-Vv6-fnAXy9pLDKnSI>`_    
